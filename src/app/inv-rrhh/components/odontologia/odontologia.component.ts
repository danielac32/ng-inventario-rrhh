...
items = [
    { title: 'Odontología 1', content: 'Lidocaína', id: 1 },
    { title: 'Odontología 2', content: 'Amoxicilina', id: 2 },
    { title: 'Odontología 3', content: 'Metronidazol', id: 3 },
    { title: 'Odontología 4', content: 'Clorhexidina', id: 4 },
    { title: 'Odontología 5', content: 'Ibuprofeno', id: 5 },
    { title: 'Odontología 6', content: 'Paracetamol', id: 6 },
    { title: 'Odontología 7', content: 'Naproxeno', id: 7 },
    { title: 'Odontología 8', content: 'Dexametasona', id: 8 }
